...
| TD-002 | Metric 3 (Vulns) | Security scans are non-blocking in CI. | Risk of shipping known HIGH vulnerabilities. | High | Add blocking gate for CRITICAL and tracked waiver for HIGH. |
